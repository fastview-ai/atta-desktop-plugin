...
2. The server listens on a fixed port: `http://127.0.0.1:17340/mcp`. The exact URL is shown in **Settings → Connect AI agent (MCP)**.

If a tool call fails to connect:

- Ask the user to **open Atta Desktop** ([download](https://atta.app/downloads)) and open or create a canvas, then retry.
